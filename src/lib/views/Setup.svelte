<script lang="ts">
  ...
  const cleanupCards = [
    { id: 'none',   name: 'Verbatim', desc: 'Exactly what you said, word for word.' },
    { id: 'light',  name: 'Light',    desc: 'Removes filler words, nothing else.' },
    { id: 'medium', name: 'Medium',   desc: 'Cleans it up, keeps your words.' },
    { id: 'high',   name: 'Direct',   desc: 'Rewrites for maximum brevity.' },
  ];

  // ── Personal tone ─────────────────────────────────────────────────────────────
  let selectedTone = 'casual';
  const toneCards = [
    { id: 'casual', name: 'Casual', desc: 'Normal caps and light punctuation.' },
    { id: 'formal', name: 'Formal', desc: 'Proper capitalization. Full stops.' },
    { id: 'plain',  name: 'Plain',  desc: 'No caps, minimal punctuation.' },
    { id: 'code',   name: 'Code',   desc: 'No filler. Raw, technical output.' },
  ];
